...
INSERT INTO local_lib.Orders
    (user_id, book_id, start_date, end_date, return_date, order_status)
VALUES (10000, 1, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', NULL, 'ACCEPTED'),
       (10000, 2, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', NULL, 'ACCEPTED'),
       (10000, 3, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', NULL, 'ACCEPTED'),
       (10000, 42, CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', NULL, 'ACCEPTED'),
       (10000, 50, CURRENT_DATE, CURRENT_DATE - INTERVAL '1 month', NULL, 'ACCEPTED'),
       (10000, 50, CURRENT_DATE - INTERVAL '1 month', CURRENT_DATE + INTERVAL '1 month', CURRENT_DATE, 'ACCEPTED');
