...
INSERT INTO local_lib.authors (first_name, second_name)
...
INSERT INTO local_lib.books (title, page_number, genre_id, publication_date, publisher_id, author_id)
VALUES ('A Daughter of the Snows', 199, 9, '2018-4-3', 5, 3),
...
INSERT INTO local_lib.storage (book_id, quantity)
VALUES (1, 3),
       (2, 3),
       (3, 5),
       (4, 1),
