const en = {
    ...
    registration_login_error_msg: 'Username must contain from 3 to 30 chars (latin letters, digits or underscore)',
    registration_email_error_msg: 'Invalid email format',
    registration_phone_error_msg: 'Phone number should contain 12 digits',
...
const ua = {
    ...
    registration_login_error_msg: 'Ім\'я користувача повинно містити від 3 до 30 символів (літери латинського алфавіту, цифри, або знак нижнього підкресення)',
    registration_email_error_msg: 'Невірний формат електронної адреси',
    registration_phone_error_msg: 'Номер телефону повинен містити 12 символів',
